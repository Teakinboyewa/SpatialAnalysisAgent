...
#%% DEBUGGING THE MODEL NAME AND REASONING EFFORT
#
# """
# Initialize the AI model with debug information printing
#
# Args:
...
#
# Returns:
#     tuple: (model, reasoning_effort) where reasoning_effort is None for non-GPT-5 models
# """
# print("=" * 60)
# print("MODEL CONFIGURATION DEBUG INFO")
# print("=" * 60)
...
#     print("Model Type: GPT-OSS-20B (Ollama Provider)")
#
#     try:
#         import SpatialAnalysisAgent_ModelProvider as ModelProvider
#         provider = ModelProvider.ModelProviderFactory.get_provider('gpt-oss-20b')
#         print(f"Provider Class: {type(provider).__name__}")
#         print(f"Provider Type: Ollama Local Provider")
#         print(f"API Method: ollama.chat() for local inference")
#
...
#     print("Provider Class: ChatOpenAI (LangChain)")
...
if User_Query_Tuning:
    task_breakdown = Query_tuning_prompt_str
else:
    task_breakdown = LLM_reply_str
